      ...
      {showRealApp ? (
        <View style={styles.container}>
          <View style={styles.container}>
            ...
            <Text style={styles.paragraphStyle}>애플독이 앞장 서겠습니다.</Text>
            <Button
              title='다시 보기'
...
const slides = [
  {
    ...
    title: "하루에 193마리",
    image: {
      uri: "https://image-notepet.akamaized.net/resize/620x-/seimage/20170612%2F1fd2b7ed26d3f13486c79a6abe963aba.jpg",
    },
